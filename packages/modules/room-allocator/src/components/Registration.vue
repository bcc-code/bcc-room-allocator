...
<template>
  <div class="guest flex items-center justify-between p-2 md:px-4 py-2 rounded-md border cursor-pointer"
       style="min-height: 4rem;"
       :class="[highlight ? 'bg-indigo-100 text-indigo-500' : 'bg-white text-gray-800', state.sortBy === 'age' && age >= state.minMentorAge ? 'mentor' : 'mentee']">
...
<style>
.guest.mentor + .mentee {
  @apply border-t-4 border-t-gray-400;
}
</style>